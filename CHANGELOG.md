...
- README hero rewritten in three short imperative sentences; "AR" removed from
  public copy (kept as a GitHub topic for discovery). MediaPipe sizing
...
- All public-facing text on three pages switched from `lang="ru"` to `lang="en"`;
  ...
  to English.
- Legacy "Ball Catcher" wording cleared from six title-bars and docstrings
...
[Unreleased]: https://github.com/lisa-elisa/wallcast/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/lisa-elisa/wallcast/releases/tag/v0.1.0
